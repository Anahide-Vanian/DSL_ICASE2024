 ...
 * </p>
 * <ul>
 *   <li>{@link dk.sdu.bdd.xtext.bddDsl.impl.DeclarativeEntityStatePhraseImpl#getProperty <em>Property</em>}</li>
...
public class DeclarativeEntityStatePhraseImpl extends MinimalEObjectImpl.Container implements DeclarativeEntityStatePhrase
{
    ...
    if (property != null && property.eIsProxy())
    {
      ...
      if (property != oldProperty)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, BddDslPackage.DECLARATIVE_ENTITY_STATE_PHRASE__PROPERTY, oldProperty, property));
      }
    }
    return property;
  }
  ...
  public void setProperty(PropertyDef newProperty)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BddDslPackage.DECLARATIVE_ENTITY_STATE_PHRASE__PROPERTY, oldProperty, property));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case BddDslPackage.DECLARATIVE_ENTITY_STATE_PHRASE__PROPERTY:
