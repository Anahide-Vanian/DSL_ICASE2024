...
public class ImperativeScenarioStateImpl extends MinimalEObjectImpl.Container implements ImperativeScenarioState
{
   ...
   * @ordered
   */
  protected EList<ImperativeStatePhrase> states;
   ...
   */
  @Override
  public EList<ImperativeStatePhrase> getStates()
  {
    if (states == null)
    {
      states = new EObjectContainmentEList<ImperativeStatePhrase>(ImperativeStatePhrase.class, this, BddDslPackage.IMPERATIVE_SCENARIO_STATE__STATES);
    }
    return states;
  }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      case BddDslPackage.IMPERATIVE_SCENARIO_STATE__STATES:
        getStates().clear();
        getStates().addAll((Collection<? extends ImperativeStatePhrase>)newValue);
        return;
    }
